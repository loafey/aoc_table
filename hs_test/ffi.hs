...
main = do
    ...
    let table' = (addToTable :: TF CInt CInt) table (sum [0..100000]) 1
    let table'' = (addToTable :: TF CFloat CBool) table' 0.2431 1
    runTable table''
...
instance Tablable CBool CFloat where addToTable = addCBoolCFloatFuncs
instance Tablable CBool CDouble where addToTable = addCBoolCDoubleFuncs
instance Tablable CBool CShort where addToTable = addCBoolCShortFuncs
instance Tablable CBool CInt where addToTable = addCBoolCIntFuncs
instance Tablable CBool CLong where addToTable = addCBoolCLongFuncs
instance Tablable CBool CSChar where addToTable = addCBoolCSCharFuncs
instance Tablable CBool CUShort where addToTable = addCBoolCUShortFuncs
instance Tablable CBool CUInt where addToTable = addCBoolCUIntFuncs
instance Tablable CBool CULong where addToTable = addCBoolCULongFuncs
instance Tablable CBool CUChar where addToTable = addCBoolCUCharFuncs
instance Tablable CFloat CBool where addToTable = addCFloatCBoolFuncs
instance Tablable CFloat CFloat where addToTable = addCFloatCFloatFuncs
instance Tablable CFloat CDouble where addToTable = addCFloatCDoubleFuncs
instance Tablable CFloat CShort where addToTable = addCFloatCShortFuncs
instance Tablable CFloat CInt where addToTable = addCFloatCIntFuncs
instance Tablable CFloat CLong where addToTable = addCFloatCLongFuncs
instance Tablable CFloat CSChar where addToTable = addCFloatCSCharFuncs
instance Tablable CFloat CUShort where addToTable = addCFloatCUShortFuncs
instance Tablable CFloat CUInt where addToTable = addCFloatCUIntFuncs
instance Tablable CFloat CULong where addToTable = addCFloatCULongFuncs
instance Tablable CFloat CUChar where addToTable = addCFloatCUCharFuncs
instance Tablable CDouble CBool where addToTable = addCDoubleCBoolFuncs
instance Tablable CDouble CFloat where addToTable = addCDoubleCFloatFuncs
instance Tablable CDouble CDouble where addToTable = addCDoubleCDoubleFuncs
instance Tablable CDouble CShort where addToTable = addCDoubleCShortFuncs
instance Tablable CDouble CInt where addToTable = addCDoubleCIntFuncs
instance Tablable CDouble CLong where addToTable = addCDoubleCLongFuncs
instance Tablable CDouble CSChar where addToTable = addCDoubleCSCharFuncs
instance Tablable CDouble CUShort where addToTable = addCDoubleCUShortFuncs
instance Tablable CDouble CUInt where addToTable = addCDoubleCUIntFuncs
instance Tablable CDouble CULong where addToTable = addCDoubleCULongFuncs
instance Tablable CDouble CUChar where addToTable = addCDoubleCUCharFuncs
instance Tablable CShort CBool where addToTable = addCShortCBoolFuncs
instance Tablable CShort CFloat where addToTable = addCShortCFloatFuncs
instance Tablable CShort CDouble where addToTable = addCShortCDoubleFuncs
instance Tablable CShort CShort where addToTable = addCShortCShortFuncs
instance Tablable CShort CInt where addToTable = addCShortCIntFuncs
instance Tablable CShort CLong where addToTable = addCShortCLongFuncs
instance Tablable CShort CSChar where addToTable = addCShortCSCharFuncs
instance Tablable CShort CUShort where addToTable = addCShortCUShortFuncs
instance Tablable CShort CUInt where addToTable = addCShortCUIntFuncs
instance Tablable CShort CULong where addToTable = addCShortCULongFuncs
instance Tablable CShort CUChar where addToTable = addCShortCUCharFuncs
instance Tablable CInt CBool where addToTable = addCIntCBoolFuncs
instance Tablable CInt CFloat where addToTable = addCIntCFloatFuncs
instance Tablable CInt CDouble where addToTable = addCIntCDoubleFuncs
instance Tablable CInt CShort where addToTable = addCIntCShortFuncs
instance Tablable CInt CInt where addToTable = addCIntCIntFuncs
instance Tablable CInt CLong where addToTable = addCIntCLongFuncs
instance Tablable CInt CSChar where addToTable = addCIntCSCharFuncs
instance Tablable CInt CUShort where addToTable = addCIntCUShortFuncs
instance Tablable CInt CUInt where addToTable = addCIntCUIntFuncs
instance Tablable CInt CULong where addToTable = addCIntCULongFuncs
instance Tablable CInt CUChar where addToTable = addCIntCUCharFuncs
instance Tablable CLong CBool where addToTable = addCLongCBoolFuncs
instance Tablable CLong CFloat where addToTable = addCLongCFloatFuncs
instance Tablable CLong CDouble where addToTable = addCLongCDoubleFuncs
instance Tablable CLong CShort where addToTable = addCLongCShortFuncs
instance Tablable CLong CInt where addToTable = addCLongCIntFuncs
instance Tablable CLong CLong where addToTable = addCLongCLongFuncs
instance Tablable CLong CSChar where addToTable = addCLongCSCharFuncs
instance Tablable CLong CUShort where addToTable = addCLongCUShortFuncs
instance Tablable CLong CUInt where addToTable = addCLongCUIntFuncs
instance Tablable CLong CULong where addToTable = addCLongCULongFuncs
instance Tablable CLong CUChar where addToTable = addCLongCUCharFuncs
instance Tablable CSChar CBool where addToTable = addCSCharCBoolFuncs
instance Tablable CSChar CFloat where addToTable = addCSCharCFloatFuncs
instance Tablable CSChar CDouble where addToTable = addCSCharCDoubleFuncs
instance Tablable CSChar CShort where addToTable = addCSCharCShortFuncs
instance Tablable CSChar CInt where addToTable = addCSCharCIntFuncs
instance Tablable CSChar CLong where addToTable = addCSCharCLongFuncs
instance Tablable CSChar CSChar where addToTable = addCSCharCSCharFuncs
instance Tablable CSChar CUShort where addToTable = addCSCharCUShortFuncs
instance Tablable CSChar CUInt where addToTable = addCSCharCUIntFuncs
instance Tablable CSChar CULong where addToTable = addCSCharCULongFuncs
instance Tablable CSChar CUChar where addToTable = addCSCharCUCharFuncs
instance Tablable CUShort CBool where addToTable = addCUShortCBoolFuncs
instance Tablable CUShort CFloat where addToTable = addCUShortCFloatFuncs
instance Tablable CUShort CDouble where addToTable = addCUShortCDoubleFuncs
instance Tablable CUShort CShort where addToTable = addCUShortCShortFuncs
instance Tablable CUShort CInt where addToTable = addCUShortCIntFuncs
instance Tablable CUShort CLong where addToTable = addCUShortCLongFuncs
instance Tablable CUShort CSChar where addToTable = addCUShortCSCharFuncs
instance Tablable CUShort CUShort where addToTable = addCUShortCUShortFuncs
instance Tablable CUShort CUInt where addToTable = addCUShortCUIntFuncs
instance Tablable CUShort CULong where addToTable = addCUShortCULongFuncs
instance Tablable CUShort CUChar where addToTable = addCUShortCUCharFuncs
instance Tablable CUInt CBool where addToTable = addCUIntCBoolFuncs
instance Tablable CUInt CFloat where addToTable = addCUIntCFloatFuncs
instance Tablable CUInt CDouble where addToTable = addCUIntCDoubleFuncs
instance Tablable CUInt CShort where addToTable = addCUIntCShortFuncs
instance Tablable CUInt CInt where addToTable = addCUIntCIntFuncs
instance Tablable CUInt CLong where addToTable = addCUIntCLongFuncs
instance Tablable CUInt CSChar where addToTable = addCUIntCSCharFuncs
instance Tablable CUInt CUShort where addToTable = addCUIntCUShortFuncs
instance Tablable CUInt CUInt where addToTable = addCUIntCUIntFuncs
instance Tablable CUInt CULong where addToTable = addCUIntCULongFuncs
instance Tablable CUInt CUChar where addToTable = addCUIntCUCharFuncs
instance Tablable CULong CBool where addToTable = addCULongCBoolFuncs
instance Tablable CULong CFloat where addToTable = addCULongCFloatFuncs
instance Tablable CULong CDouble where addToTable = addCULongCDoubleFuncs
instance Tablable CULong CShort where addToTable = addCULongCShortFuncs
instance Tablable CULong CInt where addToTable = addCULongCIntFuncs
instance Tablable CULong CLong where addToTable = addCULongCLongFuncs
instance Tablable CULong CSChar where addToTable = addCULongCSCharFuncs
instance Tablable CULong CUShort where addToTable = addCULongCUShortFuncs
instance Tablable CULong CUInt where addToTable = addCULongCUIntFuncs
instance Tablable CULong CULong where addToTable = addCULongCULongFuncs
instance Tablable CULong CUChar where addToTable = addCULongCUCharFuncs
instance Tablable CUChar CBool where addToTable = addCUCharCBoolFuncs
instance Tablable CUChar CFloat where addToTable = addCUCharCFloatFuncs
instance Tablable CUChar CDouble where addToTable = addCUCharCDoubleFuncs
instance Tablable CUChar CShort where addToTable = addCUCharCShortFuncs
instance Tablable CUChar CInt where addToTable = addCUCharCIntFuncs
instance Tablable CUChar CLong where addToTable = addCUCharCLongFuncs
instance Tablable CUChar CSChar where addToTable = addCUCharCSCharFuncs
instance Tablable CUChar CUShort where addToTable = addCUCharCUShortFuncs
instance Tablable CUChar CUInt where addToTable = addCUCharCUIntFuncs
instance Tablable CUChar CULong where addToTable = addCUCharCULongFuncs
instance Tablable CUChar CUChar where addToTable = addCUCharCUCharFuncs
